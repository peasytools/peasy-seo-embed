...
Embed [PeasySeo](https://peasyseo.com) widgets on any website with [peasy-seo-embed](https://widget.peasyseo.com):

```html
<script src="https://cdn.jsdelivr.net/npm/peasy-seo-embed@1/dist/embed.min.js"></script>
<div data-peasyseo="entity" data-slug="example"></div>
```

Zero dependencies · Shadow DOM · 4 themes (light/dark/sepia/auto) · [Widget docs](https://widget.peasyseo.com)
